...
## Тесты
- Тесты предоставлены преподавателями КТ ИТМО
- Тестируется корректность методов bitset'а
- Тестируется производительность операций
- Тестируется на отсутствие утечек
